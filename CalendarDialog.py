...
class Calendar(ttk.Frame):
    ...
    def __init__(self, master=None, **kw):
        ...
        sel_bg = kw.pop('selectbackground', '#f70000')
        ...
        #self._build_calendar(self._items)
    ...
    def __config_calendar(self):
        ...
        cal_font = font.Font()
        maxwidth = max(cal_font.measure(col) for col in cols)
        for col in cols:
    ...
    def _prev_month(self):
        ...
        #self._build_calendar(self._items)  # reconstuct calendar
        self._build_calendar()
